...
#include <cmath>
#include <string>
#include <BSP_DISCO_L476VG/Drivers/BSP/STM32L476G-Discovery/stm32l476g_discovery_audio.h>
...
//Testing audio code~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// int audio_status = BSP_AUDIO_IN_Init(SAI_AUDIO_FREQUENCY_48K, 16, 1);
// #define BUFFER_SIZE 1024
// int audio_buffer[BUFFER_SIZE];
// int audio_buffer_status = BSP_AUDIO_IN_Record(audio_buffer, 1024);
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
{    
    ...
    while(1)
    {
        ...
        //****************************************
        //TODO: make sure that it is not in normal rep count mode (done)
        //*******************************************************************
