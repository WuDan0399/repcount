...
uint16_t LSM9DS1::begin()
{
    ...
    uint8_t _xgAddress = settings.device.agAddress;
    uint8_t _mAddress = settings.device.mAddress;
...
void LSM9DS1::I2CwriteByte(uint8_t address, uint8_t subAddress, uint8_t data)
{
    ...
    */
    ...
    i2c.write(address<<1, temp_data, 2);
}
...
uint8_t LSM9DS1::I2CreadByte(uint8_t address, uint8_t subAddress)
{
    ...
    */
    ...
    i2c.write(address<<1, temp, 1);
    //i2c.write(address & 0xFE);
    temp[1] = 0x00;
    i2c.write(address<<1, temp, 1);
    //i2c.write( address | 0x01);
    int a = i2c.read(address<<1, &data, 1);
    return data;
}
...
uint8_t LSM9DS1::I2CreadBytes(uint8_t address, uint8_t subAddress, uint8_t * dest, uint8_t count)
{
    ...
    */
    ...
    i2c.write(address<<1, temp, 1);
    i2c.read(address<<1, temp_dest, count);
